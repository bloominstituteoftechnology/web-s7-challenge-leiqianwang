...
export default function Form() {
  ...
  return (
      ...
      {failure && (
        <div>
        <p>Thank you for your order, {formValue.fullName}! Your {formValue.size} pizza with {formValue.toppings.length} toppings is on the way.</p>
      ...
      <div className="input-group">
        <div>
          ...
          <select onChange={onChange} id="size" name="size" value={formValue.size}>
